...
const ar = {
  ...
  pillarsSubtitle: "المرصد يوثّق أكثر من الأبحاث العلمية — هذي الأقسام المخطّط تغطيتها لاحقًا.",
...
const en: Record<keyof typeof ar, string> = {
  ...
  pillarsSubtitle: "Al Marsad documents more than research papers — these are the sections planned for future coverage.",
